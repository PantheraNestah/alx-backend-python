...
def message_detail(request, message_id):
    ...
    # The related_name 'history' allows this simple query
    edit_history = message.history.all()
...
def delete_user_account(request):
    ...
    return render(request, 'notifications/delete_account_confirm.html')
...
def conversation_thread_view(request, message_id):
    ...
    WITH RECURSIVE message_thread AS (
        ...
        SELECT * FROM notifications_message WHERE id = %s
        UNION ALL
        -- Recursive step: select all replies
        SELECT m.* FROM notifications_message m
    ...
    return render(request, 'notifications/conversation_thread.html', {
